...
//  Github-Followers
//
//  Created by Ethan Gonsalves on 2022-10-31.
//
...
class SearchVC: UIViewController, UITextFieldDelegate {
    ...
    let callToActionButton  = GFButton(backgroundColor: .systemCyan, title: "Get Followers")
    ...
    @objc  func pushFollowerListVC() {
        ...
        let followerListVC = FollwerListVC()
